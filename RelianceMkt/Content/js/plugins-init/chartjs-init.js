(function($) {
 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(212, 0, 39, 1)',
							borderWidth: "0",
							backgroundColor: 'rgba(212, 0, 39, 1)'
						}
					]
				},
				options: {
	...
	var barChart1a = function(){
		if(jQuery('#barChart_1a').length > 0 ){
			const barChart_1a = document.getElementById("barChart_1a").getContext('2d');
			
			barChart_1a.height = 100;

			new Chart(barChart_1a, {
				type: 'bar',
				data: {
					defaultFontFamily: 'Poppins',
					labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(212, 0, 39, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(212, 0, 39, 0.5)");
