	...
	Highcharts.chart('chart1', {
		...
		series: [{
			...
			data: [{
				...
				name: 'Probable_AGNULL',
				y: 3
			}, {
				name: 'Probable_AGNULL',
				y: 46
			}, {
				name: 'Extremely high probable',
				y: 6
			}]
		}]
	});
...
/*	Highcharts.chart('chart2', {
	...
	*/
	...
	Highcharts.chart('chart7', {
		...
		title: {
			text: 'Abu Road - MOM QITA bucket wise'
		},
		/*subtitle: {
			text: 'Source: <a href="https://en.wikipedia.org/wiki/World_population">Wikipedia.org</a>'
		},*/
		xAxis: {
			categories: ['May 22 till date', 'Apr-22', 'FY 21-22'],
			title: {
				text: null
			}
		},
...
/*	// chart 8
	...
	*/// chart 9
	Highcharts.chart('chart9', {
		...
		title: {
			text: 'QITA Bucket - ARDM wise'
		},
		xAxis: {
			categories: ['DINESH KUMAR MALI', 'BHUVNESH KUMAWAT', 'Bhupendra Sambira', 'AMEET PRAJAPATI']
		},
		yAxis: {
			min: 0,
			title: {
	...
	Highcharts.chart('chart9a', {
		...
		title: {
			text: 'Rider/combo - 65K or below premium - ARDM Wise'
		},
		xAxis: {
			categories: ['DINESH KUMAR MALI', 'BHUVNESH KUMAWAT', 'Bhupendra Sambira', 'AMEET PRAJAPATI']
		},
		...
		series: [{
			name: 'Rider/Combo not opted (65 K Or below)',
			data: [99,23,71,24]
		}, {
			name: 'Rider/Combo opted (65 K Or below)',
			data: [16,1,0,0]
		}]
	});
	// chart 9b
	Highcharts.chart('chart9b', {
		chart: {
			type: 'bar',
			styledMode: true
		},
		...
		title: {
			text: 'Insta & physical nach - ARDM Wise'
		},
		xAxis: {
			categories: ['DINESH KUMAR MALI', 'BHUVNESH KUMAWAT', 'Bhupendra Sambira', 'AMEET PRAJAPATI']
		},
		...
		series: [{
			name: 'Online payment, Insta NACH not opted',
			data: [19,12,16,12]
		}, {
			name: 'Insta NACH opted',
			data: [36,8,25,7]
		}, {
			name: 'Physical Nach opted',
			data: [96,21,67,17]
		}]
	});
	// chart 9c
	Highcharts.chart('chart9c', {
		chart: {
			type: 'bar',
			styledMode: true
		},
		...
		title: {
			text: 'Premium mode summary - ARDM Wise'
		},
		xAxis: {
			categories: ['DINESH KUMAR MALI', 'BHUVNESH KUMAWAT', 'Bhupendra Sambira', 'AMEET PRAJAPATI']
		},
	...
	Highcharts.chart('chart9d', {
		...
		title: {
			text: 'Online payment & Insta nach -ARDM Wise'
		},
		xAxis: {
			categories: ['DINESH KUMAR MALI', 'BHUVNESH KUMAWAT', 'Bhupendra Sambira', 'AMEET PRAJAPATI']
		},
